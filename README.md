...
`ghcr.io/vm0-ai/pg17` so CI does not depend on anonymous Docker Hub pulls.

## Why

`vm0-ai/vm0` runs the API test shards against a `pgvector/pgvector:pg17` service container. Anonymous Docker Hub pulls
...
- [run 30157827913](https://github.com/vm0-ai/vm0/actions/runs/30157827913) - `test-api (4)`, three `registry-1.docker.io` timeouts
- [run 30162893832](https://github.com/vm0-ai/vm0/actions/runs/30162893832) - `test-api (3)`, same failure, ejected a PR from the merge queue
